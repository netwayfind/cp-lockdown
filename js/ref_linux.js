...
class PasswordPolicy extends Section {
  ...
  render() {
    return React.createElement(React.Fragment, null, React.createElement("h3", null, "Location"), React.createElement("ol", null, React.createElement("li", null, React.createElement(OpenFile).type.prototype.getLink(), " /etc/pam.d/common-password"), React.createElement("li", null, React.createElement(OpenFile).type.prototype.getLink(), " /etc/login.defs")), React.createElement("h3", null, "Settings"), "For /etc/pam.d/common-password", React.createElement("ol", null, React.createElement("li", null, "Find the following line in the file:", React.createElement("ul", null, React.createElement("li", null, "password\xA0\xA0\xA0\xA0requisite\xA0\xA0\xA0\xA0pam_cracklib.so retry=3 minlen=8 difok=3"))), React.createElement("li", null, "To require at least 10 characters, change to the following:", React.createElement("ul", null, React.createElement("li", null, "minlen=10"))), React.createElement("li", null, "To require password complexity, add to the end of the line:", React.createElement("ul", null, React.createElement("li", null, "ucredit=-1 lcredit=-1 dcredit=-1 ocredit=-1"))), React.createElement("li", null, "The line should now look like the following", React.createElement("ul", null, React.createElement("li", null, "password\xA0\xA0\xA0\xA0requisite\xA0\xA0\xA0\xA0pam_cracklib.so retry=3 minlen=10 difok=3 ucredit=-1 lcredit=-1 dcredit=-1 ocredit=-1"))), React.createElement("li", null, "Find the following line in the file:", React.createElement("ul", null, React.createElement("li", null, "password\xA0\xA0\xA0\xA0[success=1 default=ignore]\xA0\xA0\xA0\xA0pam_unix.so obscure use_authtok try_first_pass sha512"))), React.createElement("li", null, "To remember last 5 passwords, add to the end of the line:", React.createElement("ul", null, React.createElement("li", null, "remember=5"))), React.createElement("li", null, "To require at least 10 characters, add to the end of the line:", React.createElement("ul", null, React.createElement("li", null, "minlen=10"))), React.createElement("li", null, "The line should now look like the following", React.createElement("ul", null, React.createElement("li", null, "password\xA0\xA0\xA0\xA0[success=1 default=ignore]\xA0\xA0\xA0\xA0pam_unix.so obscure use_authtok try_first_pass sha512 remember=5 minlen=10"))), React.createElement("li", null, "Save the file")), "For /etc/login.defs", React.createElement("ol", null, React.createElement("li", null, "Find PASS_MAX_DAYS, set to 90"), React.createElement("li", null, "Find PASS_MIN_DAYS, set to 10"), React.createElement("li", null, "Find PASS_WARN_AGE, set to 7")));
  }
